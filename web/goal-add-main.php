            ...
            <div class="addNewGoal">
              ...
              <form id="addGoal" class="row g-3">
                <div class="col-md-8">
                  ...
                  <input type="text" class="form-control" id="goalTitle" placeholder="Eg: Run 100km in 5 weeks"
                    required />
                ...
                <div class="col-md-8">
                  <label for="specificTarget" class="form-label">Specific and Measurable Target</label>
                  <input type="number" class="form-control" id="specificTarget" placeholder="Eg: 100" />
                </div>
                ...
                <div class="col-md-8">
                  <select class="form-select" id="trackProgress" aria-label="Track Progress By" required>
                ...
                <div class="col-md-6">
                  <select class="form-select" id="category" aria-label="Select Category" required>
                ...
                <div class="col-md-8 mb-3">
                  <label for="findMentor" class="form-label">Find Mentor</label>
                  <input type="email" class="form-control" id="mentor" placeholder="Enter mentor's email" />
                </div>
    ...
    if (title != '' && startDate != '' && endDate != '' && tracking != '' && category != '') {
      ...
      $.ajax({ //$.ajax({}) - perform an AJAX (asynchronous HTTP) request
        ...
        success: function(data) { //success - A function to be run when the request succeeds
          ...
          var status = json
          .status; // used to indicate either that a JSON PARSE statement executed successfully or that a nonexception condition occurred during the JSON parse operation
          if (status == 'true') {
