      ...
      <div class="container">
        ...
        <div class="row d-flex flex-row justify-content-center mt-5">
          ...
          <div class="leftSection col-md-4">
            <div class="mt-3 mb-4">
              <img src=<?php echo $rowInfo['photo'] ?? "images/default-user.png"; ?> alt="Circle Image"
                class="rounded-circle" style="width: 200px;">
            </div>
            <div class="mt-3">
              <div class="name mt-2">
          ...
          <div class="col-md-8">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <button id="deleteAccount" type="button" class="btn btn-outline-danger" data-toggle="modal"
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <form action="./src/deleteAccount.php" method="post">
                              <button id="delete" type="submit" name="user_delete" value="<?=$user->user_id ?>"
                                class="btn btn-danger" data-toggle="modal" data-target="#message">
                                Delete
                              </button>
            ...
            <div class="card mb-3">
              <div class="card-body">
                ...
                <?php
                                    $userMentor = "SELECT COUNT(DISTINCT mentor_id) 
                                    AS MentorNo 
                                    FROM goal 
                                    WHERE mentee_id=$user->user_id";

                                    $userMentee = "SELECT COUNT(DISTINCT mentee_id) 
                                    AS MenteeNo
                                    FROM goal 
                ...
                <div class="row text-center mb-4 mt-4">
                  ...
                  <div class="vl col-lg-4 col-md-4 m-t-20">
                    <h3 class="m-b-0 font-light"><?php echo $row6['noOfGoalsAccomplished'] ?></h3><small>Goals
                      Accomplished</small>
                  </div>
                </div>
              </div>
